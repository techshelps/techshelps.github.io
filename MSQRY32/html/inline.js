...
function GetGlossaryTerms(sPopup)
{
	...
	{
		// Generated on 06/18/2003 4:00:28 AM
		...
		case 'defBuildingApplications':
			L_defBuildingApplications_TEXT='(<iterm>Microsoft Access 2000: Building Applications with Forms and Reports</iterm> contains additional information about Visual Basic, security, ActiveX controls, and delivering Access applications. It is available on the MSDN Web site.)';
		...
		case 'defComparisonOperator':
			L_defComparisonOperator_TEXT='(comparison operator: An operator that is used to compare two values or expressions. For example, (less than), (greater than), and <b>=</b> (equal to).)';
		...
		case 'defFormSelector':
			...
			break;
		case 'defFormView':
			L_defFormView_TEXT='(Form view: A window that displays a form to show or accept data. Form view is the primary means of adding and modifying data in tables. You can also change the design of a form in this view.)';
		...
		case 'grdefComparisonOperator':
			L_grdefComparisonOperator_TEXT='(comparison operator: A sign that is used in comparison criteria to compare two values. The six standards are = Equal to, &gt; Greater than, &lt; Less than, &gt;= Greater than or equal to, &lt;= Less than or equal to, and &lt;&gt; Not equal to.)';
		...
		case 'ofdiscussiongroup':
			L_ofdiscussiongroup_TEXT='(discussion group: A place on the Internet where people interact by posting and reading messages about topics that are of interest to them and the rest of a community.)';
